...
struct PullToRefreshKitLeftString{
    static let scrollToClose = "Swipe to end browsing"
    static let releaseToClose = "Release to end browsing"
}

struct PullToRefreshKitRightString{
    static let scrollToViewMore = "Swipe to browse more"
    static let releaseToViewMore = "Swipe to browse more"
}
