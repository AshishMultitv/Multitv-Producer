...
#import <UIKit/UIKit.h>
 ...
 /// Video resolution (both are 16:9 automatically reduced by one level when this device does not support current resolution
...
/// @name Attribute
///=============================================================================
// The resolution of the video, width and height MUST be set to a multiple of 2, otherwise a green border may appear during decoding playback (this videoSizeRespectingAspectRatio setting may be changed to YES)
